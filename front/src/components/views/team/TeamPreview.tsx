...
export const TeamPreview: React.FC<TeamProps> = ({
  ...
  return (
    <div className="flex flex-col items-center p-6 bg-accent max-w-xl rounded-lg shadow-lg ">
      <h1 className="text-4xl font-bold text-background mb-6">{teamName}</h1>
      <div className="flex flex-row space-x-4 h-full max-w-xl ">
        {/* Team Members List */}
        <div className="w-1/4 bg-foreground p-4 rounded-lg overflow-auto">
          {teamMembers.length ? (
        ...
        {/* Team Description */}
        <div className="w-3/4 bg-foreground p-4 rounded-lg ">
